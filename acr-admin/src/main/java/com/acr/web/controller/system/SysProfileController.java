...
import com.acr.common.utils.file.FileUploadUtils;
import com.acr.common.utils.file.FileUtils;
import com.acr.common.utils.file.MimeTypeUtils;
import com.acr.framework.web.service.TokenService;
...
public class SysProfileController extends BaseController
{
    ...
    public AjaxResult avatar(@RequestParam("avatarfile") MultipartFile file) throws Exception
    {
        ...
        {
            LoginUser loginUser = getLoginUser();
            String avatar = FileUploadUtils.upload(AcrConfig.getAvatarPath(), file, MimeTypeUtils.IMAGE_EXTENSION, true);
            if (userService.updateUserAvatar(loginUser.getUserId(), avatar))
            {
                String oldAvatar = loginUser.getUser().getAvatar();
                if (StringUtils.isNotEmpty(oldAvatar))
                {
                    FileUtils.deleteFile(AcrConfig.getProfile() + FileUtils.stripPrefix(oldAvatar));
                }
