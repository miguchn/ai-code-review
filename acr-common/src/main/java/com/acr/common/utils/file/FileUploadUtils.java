package com.acr.common.utils.file;
...
import com.acr.common.exception.file.FileNameLengthLimitExceededException;
import com.acr.common.exception.file.FileSizeLimitExceededException;
import com.acr.common.exception.file.InvalidExtensionException;
import com.acr.common.utils.DateUtils;
import com.acr.common.utils.StringUtils;
import com.acr.common.utils.uuid.IdUtils;
import com.acr.common.utils.uuid.Seq;
...
public class FileUploadUtils
{
     ...
     * 默认上传的地址
     */
    private static String defaultBaseDir = AcrConfig.getProfile();
    ...
    {
        int dirLastIndex = AcrConfig.getProfile().length() + 1;
