...
CREATE TABLE `review_delivery_record` (
  ...
  `provider` varchar(20) COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'GITHUB' COMMENT 'Git Provider',
  `channel` varchar(40) COLLATE utf8mb4_general_ci NOT NULL COMMENT '投递渠道(GITHUB_PR_SUMMARY_COMMENT)',
  `pr_number` int NOT NULL COMMENT 'PR编号',
  `idempotency_key` varchar(128) COLLATE utf8mb4_general_ci NOT NULL COMMENT '幂等键',
  `external_id` varchar(64) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '外部评论ID（GitHub comment id）',
  `delivery_status` varchar(20) COLLATE utf8mb4_general_ci NOT NULL COMMENT '投递状态(SUCCESS/FAILED)',
  `failure_message` varchar(500) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '失败原因（已脱敏）',
...
CREATE TABLE `review_git_credential` (
  ...
  `credential_name` varchar(64) COLLATE utf8mb4_general_ci NOT NULL COMMENT '凭据名称',
  `provider` varchar(20) COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'GITHUB' COMMENT 'Git Provider',
  `auth_type` varchar(20) COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'PAT' COMMENT '认证方式',
  `server_url` varchar(500) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT 'Git Web 根地址（GitLab/Gitea 必填；GitHub/Gitee 须为空）',
  `token_ciphertext` varchar(1000) COLLATE utf8mb4_general_ci NOT NULL COMMENT 'AES-GCM 加密后的 Token',
  `status` char(1) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '0' COMMENT '状态(0启用 1停用)',
  `last_check_status` varchar(20) COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'UNTESTED' COMMENT '最近检测状态',
  `last_check_message` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '最近检测结果',
...
CREATE TABLE `review_issue` (
  ...
  `provider` varchar(20) COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'GITHUB' COMMENT 'Git Provider',
  `pr_number` int NOT NULL COMMENT 'PR编号',
  `fingerprint` varchar(80) COLLATE utf8mb4_general_ci NOT NULL COMMENT '问题指纹(PR级去重)',
  ...
  `severity` varchar(20) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '严重度',
  `category` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '类别',
  `title` varchar(500) COLLATE utf8mb4_general_ci NOT NULL COMMENT '标题',
  `description` mediumtext COLLATE utf8mb4_general_ci COMMENT '描述',
  `file_path` varchar(500) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '文件路径',
  `start_line` int DEFAULT NULL COMMENT '起始行',
  `end_line` int DEFAULT NULL COMMENT '结束行',
  `evidence` mediumtext COLLATE utf8mb4_general_ci COMMENT '证据',
  `suggestion` mediumtext COLLATE utf8mb4_general_ci COMMENT '建议',
  `origin` varchar(20) COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'NEW' COMMENT '归属(NEW/EXISTING)',
  `status` varchar(30) COLLATE utf8mb4_general_ci NOT NULL COMMENT '状态',
  `resolve_note` varchar(500) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '处理说明(关闭选填/忽略误报必填)',
  `close_source` varchar(20) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '关闭来源(manual/auto_recheck)',
  `closed_by` varchar(64) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '终态操作者',
...
CREATE TABLE `review_issue_action` (
  ...
  `operator` varchar(64) COLLATE utf8mb4_general_ci NOT NULL COMMENT '操作者',
  `action_type` varchar(30) COLLATE utf8mb4_general_ci NOT NULL COMMENT '动作类型(CONFIRM/CLOSE/DISMISS)',
  `from_status` varchar(30) COLLATE utf8mb4_general_ci NOT NULL COMMENT '原状态',
  `to_status` varchar(30) COLLATE utf8mb4_general_ci NOT NULL COMMENT '新状态',
  `resolve_note` varchar(500) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '处理说明快照',
...
CREATE TABLE `review_notify_channel` (
  ...
  `channel_type` varchar(40) COLLATE utf8mb4_general_ci NOT NULL COMMENT '渠道类型(DINGTALK_ROBOT/WECOM_ROBOT/FEISHU_BOT)',
  `webhook_url_ciphertext` varchar(2000) COLLATE utf8mb4_general_ci NOT NULL COMMENT 'AES-GCM 加密后的 Webhook URL',
  `secret_ciphertext` varchar(1000) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT 'AES-GCM 加密后的加签 Secret（可空）',
  `status` char(1) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '0' COMMENT '状态(0启用 1停用)',
  `last_check_status` varchar(20) COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'UNTESTED' COMMENT '最近检测状态',
  `last_check_message` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '最近检测结果',
  `last_check_time` datetime DEFAULT NULL COMMENT '最近检测时间',
...
CREATE TABLE `review_project` (
  ...
  `provider` varchar(20) COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'GITHUB' COMMENT 'Git Provider',
  `repository_url` varchar(500) COLLATE utf8mb4_general_ci NOT NULL COMMENT '规范化仓库地址',
  `repository_owner` varchar(255) COLLATE utf8mb4_general_ci NOT NULL COMMENT '仓库所有者（命名空间前缀）',
  `repository_name` varchar(255) COLLATE utf8mb4_general_ci NOT NULL COMMENT '仓库名称',
  `repository_full_path` varchar(255) COLLATE utf8mb4_general_ci NOT NULL COMMENT '仓库全路径身份',
  `default_branch` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '默认分支',
  `pr_review_enabled` char(1) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '0' COMMENT '是否启用PR审查(0启用 1停用)',
  `pr_target_branches` varchar(1000) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT 'PR目标分支，逗号分隔',
  ...
  `review_mode` varchar(40) COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'OCR_ENGINE' COMMENT '审查方式(LLM_DIRECT=大模型审查, OCR_ENGINE=审查引擎)',
  `engine_code` varchar(40) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '审查引擎编码（仅 OCR_ENGINE 必填；LLM_DIRECT 可空）',
  `scope_exclude_patterns` varchar(2000) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '审查范围：项目排除路径 glob（换行分隔）',
  `scope_include_tests` char(1) COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'N' COMMENT '审查范围：是否审查测试文件(Y启用 N排除)',
  `scope_report_existing` char(1) COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'N' COMMENT '审查范围：是否上报历史存量问题(Y保留并标注 N剔除)',
  `scope_expand_enabled` char(1) COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'Y' COMMENT '审查范围：高影响变更自动扩展整文件(Y启用 N关闭)',
  `notify_enabled` char(1) COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'N' COMMENT '是否启用 IM 通知(Y/N)',
  `notify_channel_id` bigint DEFAULT NULL COMMENT '通知渠道ID',
  `notify_on_failure` char(1) COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'Y' COMMENT 'FAILED 时是否发送简讯(Y/N)',
  `primary_stack` varchar(40) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '项目主要语言/技术栈',
  `status` char(1) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '1' COMMENT '状态(0启用 1停用)',
  `last_check_status` varchar(20) COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'UNTESTED' COMMENT '最近检测状态',
  `last_check_message` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '最近检测结果',
  `last_check_time` datetime DEFAULT NULL COMMENT '最近检测时间',
  `last_branch_sync_status` varchar(20) COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'UNSYNCED' COMMENT '最近分支同步状态',
  `last_branch_sync_message` varchar(500) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '最近分支同步结果',
  `last_branch_sync_time` datetime DEFAULT NULL COMMENT '最近分支同步时间',
  `webhook_secret_ciphertext` varchar(1000) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT 'Webhook Secret 密文（AES-GCM）',
  `last_webhook_time` datetime DEFAULT NULL COMMENT '最近 Webhook 接收时间',
  `last_webhook_result` varchar(500) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '最近 Webhook 接收结果',
  `remark` varchar(500) COLLATE utf8mb4_general_ci DEFAULT '',
  `create_by` varchar(64) COLLATE utf8mb4_general_ci DEFAULT '',
  `create_time` datetime DEFAULT NULL,
  `update_by` varchar(64) COLLATE utf8mb4_general_ci DEFAULT '',
...
CREATE TABLE `review_task` (
  ...
  `provider` varchar(20) COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'GITHUB' COMMENT 'Git Provider',
  `pr_number` int NOT NULL COMMENT 'PR编号',
  `pr_title` varchar(500) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT 'PR标题',
  `pr_author` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT 'PR 发起人（GitHub login）',
  `source_branch` varchar(255) COLLATE utf8mb4_general_ci NOT NULL COMMENT '来源分支',
  `target_branch` varchar(255) COLLATE utf8mb4_general_ci NOT NULL COMMENT '目标分支',
  `base_sha` varchar(64) COLLATE utf8mb4_general_ci NOT NULL COMMENT 'base SHA（事件版本）',
  `head_sha` varchar(64) COLLATE utf8mb4_general_ci NOT NULL COMMENT 'head SHA（事件版本）',
  ...
  `trigger_type` varchar(20) COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'WEBHOOK' COMMENT '触发方式(WEBHOOK/MANUAL/SCHEDULE)',
  `task_status` varchar(20) COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'PENDING' COMMENT '任务状态(PENDING/RUNNING/SUCCESS/FAILED/CANCELLED)',
  `review_conclusion` varchar(20) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '审查结论(PASS/WARN/BLOCK)',
  `current_step` varchar(40) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '当前/最近执行步骤',
  `failure_step` varchar(40) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '失败步骤',
  `failure_type` varchar(40) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '失败分类',
  `failure_message` varchar(500) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '执行失败原因',
  ...
  `protocol_version` varchar(16) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '最近一次结果协议版本',
  `focus_issue_count` int DEFAULT NULL COMMENT '最近一次重点问题数(0-3)',
  `has_critical_security` char(1) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '最近一次是否存在严重安全问题(0否1是)',
  `parse_status` varchar(20) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '最近一次结果解析状态',
  `snapshot_review_mode` varchar(40) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '建单快照：审查方式',
  `snapshot_template_id` bigint DEFAULT NULL COMMENT '建单快照：模板ID',
  `snapshot_template_name` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '建单快照：模板名称',
  `snapshot_template_code` varchar(64) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '建单快照：模板编码',
  `snapshot_template_version` int DEFAULT NULL COMMENT '建单快照：模板版本',
  `snapshot_prompt_content` mediumtext COLLATE utf8mb4_general_ci COMMENT '建单快照：模板正文',
  `snapshot_model_id` bigint DEFAULT NULL COMMENT '建单快照：模型ID',
  `snapshot_model_name` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '建单快照：模型名称',
  `snapshot_model_provider` varchar(40) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '建单快照：模型厂商',
  `snapshot_model` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '建单快照：模型标识',
  `snapshot_engine_code` varchar(40) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '建单快照：引擎编码',
  `snapshot_engine_name` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '建单快照：引擎名称',
  `snapshot_scope_exclude_patterns` varchar(2000) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '快照：项目排除路径 glob（换行分隔）',
  `snapshot_scope_include_tests` char(1) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '快照：是否审查测试文件(Y/N)',
  `snapshot_scope_report_existing` char(1) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '快照：是否上报存量问题(Y/N)',
  `snapshot_scope_expand_enabled` char(1) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '快照：高影响扩展(Y/N)',
  `remark` varchar(500) COLLATE utf8mb4_general_ci DEFAULT '',
  `create_by` varchar(64) COLLATE utf8mb4_general_ci DEFAULT '',
  `create_time` datetime DEFAULT NULL,
  `update_by` varchar(64) COLLATE utf8mb4_general_ci DEFAULT '',
...
CREATE TABLE `review_task_run` (
  ...
  `run_status` varchar(20) COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'RUNNING' COMMENT '执行状态(RUNNING/SUCCESS/FAILED)',
  `current_step` varchar(40) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '当前步骤',
  `failure_step` varchar(40) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '失败步骤',
  `failure_type` varchar(40) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '失败分类',
  `failure_message` varchar(500) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '失败原因（中文）',
  `review_conclusion` varchar(20) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '审查结论(PASS/WARN/BLOCK)',
  `snapshot_review_mode` varchar(40) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '快照：审查方式',
  `snapshot_engine_code` varchar(40) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '快照：引擎编码（大模型审查可空）',
  `snapshot_engine_name` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '快照：引擎名称',
  `snapshot_engine_version` varchar(64) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '快照：引擎版本',
  `snapshot_model_id` bigint DEFAULT NULL COMMENT '快照：模型配置ID',
  `snapshot_model_name` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '快照：模型配置名称',
  `snapshot_model_provider` varchar(40) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '快照：模型厂商',
  `snapshot_model` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '快照：实际 Model 名',
  `snapshot_template_id` bigint DEFAULT NULL COMMENT '快照：模板ID',
  `snapshot_template_name` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '快照：模板名称',
  `snapshot_template_code` varchar(64) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '快照：模板编码',
  `snapshot_template_version` int DEFAULT NULL COMMENT '快照：模板版本',
  `snapshot_prompt_content` mediumtext COLLATE utf8mb4_general_ci COMMENT '快照：提示词正文',
  `snapshot_timeout_seconds` int DEFAULT NULL COMMENT '快照：超时秒数',
  `snapshot_base_sha` varchar(64) COLLATE utf8mb4_general_ci NOT NULL COMMENT '快照：base SHA',
  `snapshot_head_sha` varchar(64) COLLATE utf8mb4_general_ci NOT NULL COMMENT '快照：head SHA',
  `result_summary` varchar(1000) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '结果摘要（中文）',
  `result_json` mediumtext COLLATE utf8mb4_general_ci COMMENT '结构化结果JSON（限长）',
  `scope_decision_json` mediumtext COLLATE utf8mb4_general_ci COMMENT '范围决策快照JSON（纳入/排除/扩展/截断及原因）',
  ...
  `protocol_version` varchar(16) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '结果协议版本',
  `score_weights_json` varchar(500) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '维度满分权重快照JSON',
  `score_threshold` int DEFAULT NULL COMMENT '预警分数线(预留)',
  `focus_issue_count` int DEFAULT NULL COMMENT '重点问题数(0-3)',
  `has_critical_security` char(1) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '是否存在严重安全问题(0否1是)',
  `top_issues_json` mediumtext COLLATE utf8mb4_general_ci COMMENT 'Top3重点问题JSON',
  `parse_status` varchar(20) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '结果解析状态(SUCCESS/FAILED)',
  `parse_error` varchar(500) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '解析失败原因',
  `raw_response_excerpt` mediumtext COLLATE utf8mb4_general_ci COMMENT '模型原始响应摘要(诊断)',
  `rendered_prompt` mediumtext COLLATE utf8mb4_general_ci COMMENT '最终完整提示词(截断)',
  `pr_description` varchar(4000) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT 'PR描述摘要(截断)',
  `commit_messages` varchar(4000) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT 'Commit Message摘要(截断)',
...
CREATE TABLE `review_template` (
  ...
  `tech_stack` varchar(40) COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'FULLSTACK' COMMENT '适用技术栈',
  `content` mediumtext COLLATE utf8mb4_general_ci NOT NULL COMMENT '提示词正文（支持占位符）',
  `version_no` int NOT NULL DEFAULT '1' COMMENT '模板版本号',
  `builtin_flag` char(1) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '0' COMMENT '是否内置(1是 0否)',
  `status` char(1) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '0' COMMENT '状态(0启用 1停用)',
  `remark` varchar(500) COLLATE utf8mb4_general_ci DEFAULT '',
  `create_by` varchar(64) COLLATE utf8mb4_general_ci DEFAULT '',
  `create_time` datetime DEFAULT NULL,
...
CREATE TABLE `review_webhook_event` (
  ...
  `provider` varchar(20) COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'GITHUB' COMMENT 'Git Provider',
  `delivery_id` varchar(64) COLLATE utf8mb4_general_ci NOT NULL COMMENT '平台投递ID（幂等键）',
  `event_type` varchar(40) COLLATE utf8mb4_general_ci NOT NULL COMMENT '事件类型(pull_request/ping等)',
  `action` varchar(40) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT 'PR动作(opened/reopened/synchronize等)',
  `repository_owner` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '仓库所有者',
  `repository_name` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '仓库名称',
  `repository_full_path` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '仓库全路径（审计）',
  `project_id` bigint DEFAULT NULL COMMENT '匹配的项目ID',
  `pr_number` int DEFAULT NULL COMMENT 'PR编号',
  `pr_title` varchar(500) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT 'PR标题',
  `source_branch` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '来源分支',
  `target_branch` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '目标分支',
  `base_sha` varchar(64) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT 'base SHA',
  `head_sha` varchar(64) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT 'head SHA',
  `process_status` varchar(20) COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'RECEIVED' COMMENT '处理状态(RECEIVED/ACCEPTED/IGNORED/DUPLICATE/FAILED)',
  `process_message` varchar(500) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '处理结果说明',
...
CREATE TABLE `sys_ai_model_config` (
  ...
  `provider` varchar(32) COLLATE utf8mb4_general_ci NOT NULL COMMENT '模型厂商(openai/anthropic/qwen/deepseek/custom)',
  ...
  `api_url` varchar(500) COLLATE utf8mb4_general_ci NOT NULL COMMENT '模型地址',
  `api_key` varchar(500) COLLATE utf8mb4_general_ci NOT NULL COMMENT 'API Key(接入审查前必须加密存储)',
  `model` varchar(64) COLLATE utf8mb4_general_ci DEFAULT '' COMMENT 'Model 名称',
  `embedding_model` varchar(64) COLLATE utf8mb4_general_ci DEFAULT '' COMMENT 'Embedding Model 名称',
  `embedding_api_url` varchar(500) COLLATE utf8mb4_general_ci DEFAULT '' COMMENT 'Embedding 接口地址',
  `enabled` char(1) COLLATE utf8mb4_general_ci DEFAULT '0' COMMENT '是否启用(0否 1是)',
  `is_default` char(1) COLLATE utf8mb4_general_ci DEFAULT '0' COMMENT '是否默认模型(0否 1是)',
  ...
  `last_check_result` varchar(500) COLLATE utf8mb4_general_ci DEFAULT '' COMMENT '最近检测结果',
  `last_check_time` datetime DEFAULT NULL COMMENT '最近检测时间',
...
CREATE TABLE `sys_business_system` (
  ...
  `system_name` varchar(100) COLLATE utf8mb4_general_ci NOT NULL COMMENT '业务系统名称',
  `system_code` varchar(64) COLLATE utf8mb4_general_ci NOT NULL COMMENT '业务系统编码(唯一)',
  `dept_id` bigint DEFAULT NULL COMMENT '所属部门ID',
  `manager_ids` varchar(500) COLLATE utf8mb4_general_ci DEFAULT '' COMMENT '管理用户ID列表(逗号分隔)',
...
INSERT INTO `sys_dict_data` (`dict_code`, `dict_sort`, `dict_label`, `dict_value`, `dict_type`, `css_class`, `list_class`, `is_default`, `status`, `create_by`, `create_time`, `update_by`, `update_time`, `remark`) VALUES (154,6,'复核中','RECHECKING','review_issue_status','','primary','N','0','admin','2026-08-03 08:08:26','',NULL,'预留，本期不实现');
...
INSERT INTO `sys_dict_data` (`dict_code`, `dict_sort`, `dict_label`, `dict_value`, `dict_type`, `css_class`, `list_class`, `is_default`, `status`, `create_by`, `create_time`, `update_by`, `update_time`, `remark`) VALUES (156,2,'自动复核','auto_recheck','review_issue_close_source','','info','N','0','admin','2026-08-03 08:08:26','',NULL,'预留');
